...
const Empty: React.FC<{ text: string }> = ({ text }) => <div className="bg-white border border-slate-200 rounded-xl p-5 text-xs text-slate-400">{text}</div>;
