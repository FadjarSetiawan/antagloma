...
class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'payment_proof_url'   => $this->payment_proof_path ? url('/api/storage/' . ltrim($this->payment_proof_path, '/')) : null,
            'plant_photo_path'    => $this->plant_photo_path,
            'plant_photo_url'     => $this->plant_photo_path ? url('/api/storage/' . ltrim($this->plant_photo_path, '/')) : null,
